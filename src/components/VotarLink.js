...
export const VotarLink = ({ idLink, loggedUserVote, addVoteToLink }) => {
  ...
  return (
    <form className="clasificacion">
      ...
      <label className="estrella" htmlFor={`link-${idLink}voto5`}>★</label>
      ...
      <label className="estrella" htmlFor={`link-${idLink}voto4`}>★</label>
      ...
      <label className="estrella" htmlFor={`link-${idLink}voto3`}>★</label>
      ...
      <label className="estrella" htmlFor={`link-${idLink}voto2`}>★</label>
      ...
      <label className="estrella" htmlFor={`link-${idLink}voto1`}>★</label>
